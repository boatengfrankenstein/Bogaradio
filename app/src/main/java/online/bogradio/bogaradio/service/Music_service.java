package online.bogradio.bogaradio.service;
...
public class Music_service extends Service implements MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, AudioManager.OnAudioFocusChangeListener {
    ...
    String url = "http://shaincast.caster.fm:48462/listen.mp3";
           // "rtsp://iptv.cybertap.com.ar:1935/fmvida/fmvida.stream";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        NotificationCompat.Builder mBuilder =
                new NotificationCompat.Builder(this)
                        ...
                        .setColor(0xff123456)
                        .setContentTitle("Bogaradio")
                        .setContentText("Come on board..");
